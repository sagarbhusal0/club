  ...
  return (
    <div className="bg-[#f8f7f5] dark:bg-zinc-950">
      ...
      <Card className="mt-6 space-y-4">
        ...
        {single && <div style={{ animation:"scaleIn 220ms var(--ease-out) both" }}><CardRow a={single} /></div>}
        {list && list.length>0 && (
          <div className="grid gap-3" style={{ animation:"scaleIn 220ms var(--ease-out) both" }}>
            ...
            {list.map((a) => <CardRow key={a.applicationNumber} a={a} />)}
          </div>
        )}
      </Card>
      </div>
