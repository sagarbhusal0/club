...
export default async function TeamDetail({ params }: { params: Promise<{ id:string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Card><h3 className="font-bold">Idea Review</h3><div className="mt-4"><IdeaStatusUpdate id={team.id} current={team.ideaStatus} notes={team.ideaReviewNotes} /></div></Card>
