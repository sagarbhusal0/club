export default function RegisterPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 sm:py-10">
      <h1 className="text-xl font-bold tracking-tight sm:text-2xl">Hackathon Registration — Closed</h1>
      <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-5 sm:p-6 dark:border-amber-900 dark:bg-amber-950/30">
        ...
        <p className="mt-1 text-sm leading-relaxed text-amber-800 dark:text-amber-300">Hackathon is currently closed for new teams. Check back later or track your existing team below.</p>
