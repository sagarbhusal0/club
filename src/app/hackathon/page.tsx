  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:py-12">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
        ...
        <Link href="/hackathon/guide" className="inline-flex min-h-12 w-full items-center justify-center rounded-xl border border-zinc-200 bg-white px-6 py-3.5 text-sm font-semibold transition-colors hover:bg-zinc-50 active:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800 sm:w-auto">Guide & Preparation →</Link>
